...
<h4 id="Selector_4">6.4、SelectionKey</h4>
...
就像向Selector注册通道一节中所描述的，interest集合是你所选择的感兴趣的事件集合。可以通过SelectionKey读写interest集合，像这样：
    ...
    boolean isInterestOfAccept = (interestSet & SelectionKey.OP_ACCEPT) == SelectionKey.OP_ACCEPT;

<h4 id="Selector_5">6.5、</h4>

<h4 id="Selector_6">6.6、</h4>

<h4 id="Selector_7">6.7、</h4>
